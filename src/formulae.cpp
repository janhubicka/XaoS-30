...
constexpr std::array<FormulaInfo,33> infos{{
    ...
    {Formula::Barnsley1,"Barnsley1 Mandelbrot","barnsley"},
    {Formula::Barnsley2,"Barnsley2 Mandelbrot","barnsley2"},
    {Formula::Barnsley3,"Barnsley3 Mandelbrot","barnsley3"},
    {Formula::Octo,"Octo","octo"},
    {Formula::Phoenix,"MandPhoenix","phoenix"},
    ...
    {Formula::Lambda,"Lambda Mandelbrot","mlambda"},
    ...
    {Formula::SymmetricBarnsley,"Symmetric Barnsley M.","symbarn"},
